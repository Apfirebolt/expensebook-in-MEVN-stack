(window.webpackJsonp = window.webpackJsonp || []).push([['chunk-623c71d7'], {
  '511a': function (t, e, o) {
    const n = function () {
    ...
    }; const i = []; const s = { name: 'DesktopMenu' }; const a = s; const r = o('2877'); const l = Object(r.a)(a, n, i, !1, null, null, null); e.a = l.exports;
  },
  '6ae6': function (t, e, o) {
    const n = function () { const t = this; const e = t.$createElement; const o = t._self._c || e; return o('form', { staticClass: 'font-medium text-gray-700', on: { submit(e) { return e.preventDefault(), t.submitForm.apply(null, arguments); } } }, [o('p', [t._v(` ${t._s(t.message)} `)]), o('div', { staticClass: 'flex justify-between mt-6' }, [o('t-button', { attrs: { type: 'button', variant: 'error' }, on: { click(e) { return t.$emit('cancel'); } } }, [t._v(' Cancel ')]), o('t-button', { attrs: { type: 'submit' } }, [t._v(' Submit ')])], 1)]); }; const i = []; const s = { name: 'ConfirmModal', props: { message: { type: String, required: !0 } }, methods: { submitForm() { this.$emit('confirm'); } } }; const a = s; const r = o('2877'); const l = Object(r.a)(a, n, i, !1, null, null, null); e.a = l.exports;
  },
  '7db0': function (t, e, o) {
    const n = o('23e7'); const i = o('b727').find; const s = o('44d2'); const a = 'find'; let r = !0; a in [] && Array(1)[a]((() => { r = !1; })), n({ target: 'Array', proto: !0, forced: r }, { find(t) { return i(this, t, arguments.length > 1 ? arguments[1] : void 0); } }), s(a);
  },
  a2f4(t, e, o) {
    o.r(e); const n = function () {
      const t = this; const e = t.$createElement; const o = t._self._c || e; return o('div', { staticClass: 'bg-white shadow-sm rounded-md' }, [o('t-modal', { attrs: { header: 'Add Income' }, model: { value: t.isAddIncomeModalOpened, callback(e) { t.isAddIncomeModalOpened = e; }, expression: 'isAddIncomeModalOpened' } }, [o('add-income-form', { on: { submit: t.addIncome, cancel(e) { t.isAddIncomeModalOpened = !1; } } })], 1), o('t-modal', { attrs: { header: 'Update Income' }, model: { value: t.isUpdateModalOpened, callback(e) { t.isUpdateModalOpened = e; }, expression: 'isUpdateModalOpened' } }, [o('update-income-form', { attrs: { income: t.selectedIncome }, on: { updateIncome: t.updateIncome, cancel(e) { t.isUpdateModalOpened = !1; } } })], 1), o('t-modal', { attrs: { header: 'Confirm Delete' }, model: { value: t.isConfirmModalOpened, callback(e) { t.isConfirmModalOpened = e; }, expression: 'isConfirmModalOpened' } }, [o('confirm-modal', { attrs: { message: t.deleteMessage }, on: { confirm: t.deleteIncome, cancel(e) { t.isConfirmModalOpened = !1; } } })], 1), o('div', [o('transition', {
        attrs: {
      ...
      })])])]), o('main', { staticClass: 'flex-1' }, [o('div', { staticClass: 'py-6' }, [o('div', { staticClass: 'max-w-7xl flex justify-between mx-auto px-4 sm:px-6 md:px-8' }, [o('h1', { staticClass: 'text-2xl font-semibold text-gray-900' }, [t._v(' Income ')]), o('t-button', { on: { click(e) { t.isAddIncomeModalOpened = !0; } } }, [t._v(' Add Income ')])], 1), o('div', { staticClass: 'max-w-7xl mx-auto px-4 sm:px-6 md:px-8' }, [o('div', { staticClass: 'my-2 border-4 border-dashed border-gray-200 px-2 py-4 rounded-lg' }, [o('div', { staticClass: 'grid grid-cols-2 sm:grid-cols-4 gap-x-6 gap-y-4 sm:gap-8 sm:my-4' }, t._l(t.allIncomes, ((e) => o('div', { key: e._id }, [o('income-card', { attrs: { income: e }, on: { deleteIncome: t.openConfirmDeleteModal, updateIncome: t.openUpdateIncomeModal } })], 1))), 0)])])])])])], 1)], 1);
    }; const i = [function () { const t = this; const e = t.$createElement; const o = t._self._c || e; return o('div', { staticClass: 'flex items-center flex-shrink-0 px-4' }, [o('img', { staticClass: 'h-8 w-auto', attrs: { src: 'https://tailwindui.com/img/logos/workflow-logo-indigo-300-mark-white-text.svg', alt: 'Workflow' } })]); }, function () { const t = this; const e = t.$createElement; const o = t._self._c || e; return o('div', { staticClass: 'flex-shrink-0 flex border-t border-indigo-800 p-4' }, [o('a', { staticClass: 'flex-shrink-0 w-full group block', attrs: { href: '#' } }, [o('div', { staticClass: 'flex items-center' }, [o('div', [o('img', { staticClass: 'inline-block h-9 w-9 rounded-full', attrs: { src: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80', alt: '' } })]), o('div', { staticClass: 'ml-3' }, [o('p', { staticClass: 'text-sm font-medium text-white' }, [t._v('Tom Cook')]), o('p', { staticClass: 'text-xs font-medium text-indigo-200 group-hover:text-white' }, [t._v(' View profile ')])])])])]); }]; const s = o('5530'); const a = (o('7db0'), o('d3b7'), o('2f62')); const r = o('cd93'); const l = function () { const t = this; const e = t.$createElement; const o = t._self._c || e; return o('ValidationObserver', { scopedSlots: t._u([{ key: 'default', fn(e) { const n = e.handleSubmit; return [o('form', { staticClass: 'font-medium text-gray-700', on: { submit(e) { return e.preventDefault(), n(t.submitForm); } } }, [o('div', { staticClass: 'grid grid-cols-1 gap-x-6 gap-y-4 sm:gap-8 sm:my-4' }, [o('ValidationProvider', { attrs: { name: 'Income Source', rules: 'required' }, scopedSlots: t._u([{ key: 'default', fn(e) { const n = e.errors; return [o('t-input-group', { attrs: { label: 'Income Source', feedback: n[0], variant: n.length > 0 ? 'danger' : '' } }, [o('t-select', { attrs: { placeholder: 'Select Income Source', options: t.sourceChoices, name: 'Source' }, model: { value: t.incomeData.source, callback(e) { t.$set(t.incomeData, 'source', e); }, expression: 'incomeData.source' } })], 1)]; } }], null, !0) })], 1), t.incomeData.period === 'One Time' ? o('div', { staticClass: 'grid grid-cols-1 gap-x-6 gap-y-4 sm:gap-8 sm:my-4' }, [o('ValidationProvider', { attrs: { name: 'Income Date' }, scopedSlots: t._u([{ key: 'default', fn(e) { const n = e.errors; return [o('t-input-group', { attrs: { label: 'Income Date', feedback: n[0], variant: n.length > 0 ? 'danger' : '' } }, [o('t-datepicker', { model: { value: t.incomeData.date, callback(e) { t.$set(t.incomeData, 'date', e); }, expression: 'incomeData.date' } })], 1)]; } }], null, !0) })], 1) : t._e(), o('div', { staticClass: 'grid grid-cols-1 gap-x-6 gap-y-4 sm:gap-8 sm:my-4' }, [o('ValidationProvider', { attrs: { name: 'Income Amount', rules: 'required' }, scopedSlots: t._u([{ key: 'default', fn(e) { const n = e.errors; return [o('t-input-group', { attrs: { label: 'Enter Income Amount', feedback: n[0], variant: n.length > 0 ? 'danger' : '' } }, [o('t-input', { attrs: { type: 'number', name: 'Amount', variant: n.length > 0 ? 'danger' : '' }, model: { value: t.incomeData.amount, callback(e) { t.$set(t.incomeData, 'amount', e); }, expression: 'incomeData.amount' } })], 1)]; } }], null, !0) })], 1), o('div', { staticClass: 'grid grid-cols-1 gap-x-6 gap-y-4 sm:gap-8 sm:my-4' }, [o('t-input-group', { attrs: { label: 'Income Duration' } }, [o('t-select', { attrs: { placeholder: 'Select Duration', options: t.periodChoices, name: 'Duration' }, model: { value: t.incomeData.period, callback(e) { t.$set(t.incomeData, 'period', e); }, expression: 'incomeData.period' } })], 1)], 1), o('div', { staticClass: 'grid grid-cols-1 gap-x-6 gap-y-4 sm:gap-8 sm:my-4' }, [o('t-input-group', { attrs: { label: 'Income Desription' } }, [o('t-textarea', { attrs: { rows: '10', cols: '60', placeholder: 'Describe your income in some detail' }, model: { value: t.incomeData.content, callback(e) { t.$set(t.incomeData, 'content', e); }, expression: 'incomeData.content' } })], 1)], 1), o('div', { staticClass: 'flex justify-between mt-6' }, [o('t-button', { attrs: { type: 'button', variant: 'error' }, on: { click(e) { return t.$emit('cancel'); } } }, [t._v(' Cancel ')]), o('t-button', { attrs: { type: 'submit' } }, [t._v(' Submit ')])], 1)])]; } }]) }); }; const d = []; const c = {
      name: 'AddUpdateIncomeForm', props: { income: { type: Object, required: !1 } }, data() { return { incomeData: { content: '' }, periodChoices: ['1 Month', '3 Months', '6 Months', '1 Year', 'One Time', 'NA'], sourceChoices: ['Monthly Full-Time Salary', 'Freelance', 'Investment', 'Other'] }; }, mounted() { this.income && (this.incomeData = this.income); }, methods: { submitForm() { this.income ? this.$emit('updateIncome', this.incomeData) : this.$emit('submit', this.incomeData); }, handleContentUpdate(t) { this.incomeData = { content: t }; } },
    }; const m = c; const u = o('2877'); const h = Object(u.a)(m, l, d, !1, null, null, null); const p = h.exports; const x = function () {
      const t = this; const e = t.$createElement; const o = t._self._c || e; return o('div', { staticClass: 'p-2 bg-yellow-100 rounded' }, [o('p', { staticClass: 'truncate font-semibold text-center my-2' }, [t._v(` ${t._s(t.income.source)} `)]), o('p', { staticClass: 'text-center text-gray-700 px-2 py-1 rounded my-2 font-medium' }, [t._v(' Amount '), o('span', { staticClass: 'inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-green-400 text-white' }, [t._v(t._s(t.income.amount))])]), o('div', { staticClass: 'flex items-center justify-center my-2' }, [o('span', { staticClass: 'mx-1 cursor-pointer', on: { click(e) { return e.preventDefault(), t.editIncome.apply(null, arguments); } } }, [o('svg', {
        staticClass: 'w-6 h-6',
        attrs: {
      ...
      })])]), o('span', { staticClass: 'mx-1 cursor-pointer', on: { click(e) { return e.preventDefault(), t.deleteIncome.apply(null, arguments); } } }, [o('svg', {
        staticClass: 'w-6 h-6',
        attrs: {
          fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg',
        },
    ...
    }; const f = []; const v = { name: 'IncomeCard', props: { income: { type: Object, required: !0 } }, methods: { submitForm() { this.$emit('submit', this.incomeData); }, deleteIncome() { this.$emit('deleteIncome', this.income._id); }, editIncome() { this.$emit('updateIncome', this.income._id); } } }; const g = v; const w = Object(u.a)(g, x, f, !1, null, null, null); const k = w.exports; const b = o('511a'); const C = o('f5c7'); const y = o('6ae6'); const M = {
      name: 'IncomeHome',
      components: {
        AddIncomeForm: p, UpdateIncomeForm: p, DesktopSidebarComponent: b.a, MobileMenuComponent: C.a, IncomeCard: k, ConfirmModal: y.a,
      },
      data() {
        return {
          isAddIncomeModalOpened: !1, showSidebar: !0, isConfirmModalOpened: !1, isUpdateModalOpened: !1, selectedIncome: null, deleteMessage: '',
        };
      },
      computed: Object(s.a)({}, Object(a.c)({ allIncomes: r.c })),
      mounted() { this.getAllIncomes(); },
      methods: Object(s.a)(Object(s.a)({}, Object(a.b)({
        addIncomeAction: r.a, updateIncomeAction: r.i, deleteIncomeAction: r.b, getAllIncomes: r.d,
      })), {}, {
        addIncome(t) {
          const e = {
            source: t.source, content: t.content, duration: t.period, amount: t.amount, date: t.period === 'One Time' ? t.date : void 0,
          }; this.addIncomeAction(e), this.isAddIncomeModalOpened = !1, this.getAllIncomes();
        },
        closeSidebar() { this.showSidebar = !this.showSidebar; },
        deleteIncome() { this.isConfirmModalOpened = !1, this.deleteIncomeAction(this.selectedIncome._id), this.getAllIncomes(); },
        openUpdateIncomeModal(t) { this.isUpdateModalOpened = !0, this.selectedIncome = this.allIncomes.find(((e) => e._id === t)); },
        updateIncome() { this.isUpdateModalOpened = !1, this.updateIncomeAction(this.selectedIncome), this.getAllIncomes(); },
        openConfirmDeleteModal(t) { this.isConfirmModalOpened = !0, this.selectedIncome = this.allIncomes.find(((e) => e._id === t)), this.deleteMessage = 'Are you sure you want to delete Income title "'.concat(this.selectedIncome.source, '" ?'); },
      }),
    }; const I = M; const _ = Object(u.a)(I, n, i, !1, null, null, null); e.default = _.exports;
  },
  f5c7(t, e, o) {
    const n = function () {
    ...
    }; const i = []; const s = { name: 'MobileMenu' }; const a = s; const r = o('2877'); const l = Object(r.a)(a, n, i, !1, null, null, null); e.a = l.exports;
  },
}]);
// # sourceMappingURL=chunk-623c71d7.64c41711.js.map
